...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    SnacksPickerGitStatusAdded({ fg = Added.fg }),
    SnacksPickerGitStatusDeleted({ fg = Removed.fg }),
    SnacksPickerGitStatusIgnored({ fg = NonText.fg }),
    SnacksPickerGitStatusStaged({ fg = DiagnosticHint.fg }),
    SnacksPickerGitStatusUnmerged({ fg = DiagnosticError.fg }),
    SnacksPickerGitStatusUntracked({ fg = Removed.fg }),
