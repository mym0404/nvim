...
local vcs = {
  added = {
    label = { fg = "#C3E887" },
    code = { bg = "#10231c", fg = "#C3E887" },
  },
  changed = {
    label = { fg = "#80CBC4" },
    code = { bg = "#231e14", fg = "#80CBC4" },
  },
  removed = {
    label = { fg = "#F77669" },
    code = { bg = "#2c171b", fg = "#F77669" },
  },
  ignored = {
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Changed(vcs.changed.code),
    DiffDelete(vcs.removed.code),
    Removed(vcs.removed.code),
    ...
    sym("@lsp.type.identifier")({ fg = "#ffffff" }),
    ...
    BufferLineNumbersVisible({ fg = text_sub.fg }),
    BufferLinePick({ fg = text_sub.fg }),
    BufferLinePickSelected({ fg = text.fg, gui = "bold" }),
    BufferLinePickVisible({ fg = text_sub.fg }),
    ...
    GitSignsChange(vcs.changed.label),
    GitSignsDelete(vcs.removed.label),
    ...
    GitSignsStagedChange(vcs.changed.label),
    GitSignsStagedChangeCul(vcs.changed.label),
    GitSignsStagedChangedelete(vcs.changed.label),
    GitSignsStagedChangedeleteCul(vcs.changed.label),
    GitSignsStagedChangedeleteLn(vcs.changed.label),
    GitSignsStagedChangedeleteNr(vcs.changed.label),
    GitSignsStagedChangeLn(vcs.changed.label),
    GitSignsStagedChangeNr(vcs.changed.label),
    GitSignsStagedDelete(vcs.removed.label),
    GitSignsStagedDeleteCul(vcs.removed.label),
    GitSignsStagedDeleteNr(vcs.removed.label),
    GitSignsStagedTopdelete(vcs.removed.label),
    GitSignsStagedTopdeleteCul(vcs.removed.label),
    GitSignsStagedTopdeleteNr(vcs.removed.label),
    GitSignsStagedUntracked(vcs.removed.label),
    GitSignsStagedUntrackedCul(vcs.removed.label),
    GitSignsStagedUntrackedLn(vcs.removed.label),
    GitSignsStagedUntrackedNr(vcs.removed.label),
    ...
    SnacksPickerGitBranch(vcs.removed.label),
    ...
    SnacksPickerGitStatusDeleted(vcs.removed.label),
    SnacksPickerGitStatusIgnored(vcs.ignored.label),
    SnacksPickerGitStatusStaged(vcs.changed.label),
