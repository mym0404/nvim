...
local keyword = { fg = "#A7D5FF" }
local modifier = { fg = "#A7D5FF" }
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    FloatBorder(border),
    NormalFloat({ fg = "#ffffff", bg = "#242424" }),
    NormalNC({ fg = "#e6edf3" }),
    ...
    BlinkCmpDoc({ NormalFloat, bg = "#333333" }),
    BlinkCmpSignatureHelp({ NormalFloat, bg = "#333333" }),
