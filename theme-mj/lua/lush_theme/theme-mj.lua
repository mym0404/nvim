...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    SnacksPickerLspUnavailable({ DiagnosticError }),
    SnacksPickerGitStatusUnmerged({ DiagnosticError }),
    lualine_x_7({ DiagnosticError }),
    SnacksNotifierFooterError({ DiagnosticError }),
    DiagnosticWarn({ fg = "#d29922" }),
    ...
    SnacksPickerGitDetached({ DiagnosticWarn }),
    SnacksPickerLspAttached({ DiagnosticWarn }),
    SnacksPickerLspDisabled({ DiagnosticWarn }),
    ...
    DiagnosticVirtualTextError({ fg = "#f85149" }),
    NoiceFormatLevelError({ DiagnosticVirtualTextError }),
    DiagnosticVirtualTextWarn({ fg = "#d29922" }),
    NoiceFormatLevelWarn({ DiagnosticVirtualTextWarn }),
    DiagnosticVirtualTextInfo({ fg = "#2f81f7" }),
    ...
    Comment({ fg = "#8b949e", gui = "nocombine" }),
    ...
    sym("@markup.heading.1.delimiter.vimdoc")({ bg = "bg", fg = "bg", gui = "underdouble,nocombine", sp = "fg" }),
    sym("@markup.heading.2.delimiter.vimdoc")({ bg = "bg", fg = "bg", gui = "underline,nocombine", sp = "fg" }),
    ...
    luaParenError({ Error }),
    luaError({ Error }),
    DiagnosticUnderlineError({ gui = "undercurl", sp = "#f85149" }),
    ...
    sym("@keyword.function")({ fg = "#ff7b72" }),
    sym("@keyword.exception")({ fg = "#79c0ff" }),
    ...
    sym("@keyword.operator")({ fg = "#ff7b72" }),
    ...
    sym("@keyword.directive.rust")({ fg = "#79c0ff" }),
    sym("@constant.builtin.rust")({ fg = "#ffa657" }),
    sym("@label.ruby")({ fg = "#79c0ff" }),
    sym("@variable.member.python")({ fg = "#e6edf3" }),
    sym("@markup.quote.markdown")({ fg = "#7ee787" }),
    sym("@punctuation.delimiter.markdown_inline")({ fg = "#e6edf3" }),
    sym("@punctuation.delimiter.markdown")({ fg = "#e6edf3" }),
    sym("@markup.list.luadoc")({ fg = "#e6edf3" }),
    sym("@operator.luadoc")({ fg = "#e6edf3" }),
    sym("@property.lua")({ fg = "#e6edf3" }),
    sym("@property.luadoc")({ sym("@property.lua") }),
    sym("@module.builtin.lua")({ fg = "#79c0ff" }),
    sym("@function.builtin.lua")({ fg = "#79c0ff" }),
    sym("@operator.lua")({ fg = "#ff7b72" }),
    sym("@markup.heading.html")({ fg = "#e6edf3" }),
    sym("@module.c_sharp")({ fg = "#ffa657" }),
    sym("@punctuation.delimiter.bash")({ fg = "#ff7b72" }),
    sym("@function.call.bash")({ fg = "#79c0ff" }),
    sym("@function.builtin.bash")({ fg = "#ff7b72" }),
    sym("@operator.bash")({ fg = "#ff7b72" }),
    ...
    CocExplorerGitUntracked({ fg = "#8b949e" }),
    CocExplorerGitIgnored({ fg = "#8b949e" }),
    CocExplorerGitPathChange({ fg = "#a371f7" }),
    CocExplorerGitContentChange({ fg = "#d29922" }),
    CocExplorerGitModified({ fg = "#d29922" }),
    CocExplorerGitAdded({ fg = "#3fb950" }),
    ...
    BufferLineDuplicateVisible({ bg = "#0b0f15", fg = "#848c96", gui = "italic" }),
    ...
    BufferLinePickVisible({ bg = "#0b0f15", fg = "#f85149", gui = "bold,italic" }),
    BufferLinePickSelected({ bg = "#0d1117", fg = "#f85149", gui = "bold,italic" }),
    ...
    BufferLineDuplicateSelected({ bg = "#0d1117", fg = "#848c96", gui = "italic" }),
    BufferLineModifiedSelected({ bg = "#0d1117", fg = "#a5d6ff" }),
    BufferLineModifiedVisible({ bg = "#0b0f15", fg = "#a5d6ff" }),
    BufferLineErrorDiagnosticSelected({ bg = "#0d1117", fg = "#ba3c36", gui = "bold,italic", sp = "#ba3c36" }),
    BufferLineErrorDiagnosticVisible({ bg = "#0b0f15", fg = "#686f76" }),
    BufferLineErrorDiagnostic({ bg = "#090c11", fg = "#686f76", sp = "#ba3c36" }),
    BufferLineErrorSelected({ bg = "#0d1117", fg = "#f85149", gui = "bold,italic", sp = "#f85149" }),
    BufferLineErrorVisible({ bg = "#0b0f15", fg = "#8b949e" }),
    BufferLineWarningDiagnosticSelected({ bg = "#0d1117", fg = "#9d7219", gui = "bold,italic", sp = "#9d7219" }),
    BufferLineDiagnostic({ bg = "#090c11", fg = "#686f76" }),
    BufferLineWarningDiagnostic({ bg = "#090c11", fg = "#686f76", sp = "#9d7219" }),
    BufferLineWarningSelected({ bg = "#0d1117", fg = "#d29922", gui = "bold,italic", sp = "#d29922" }),
    BufferLineWarningVisible({ bg = "#0b0f15", fg = "#8b949e" }),
    BufferLineInfoDiagnosticSelected({ bg = "#0d1117", fg = "#2360b9", gui = "bold,italic", sp = "#2360b9" }),
    BufferLineInfoDiagnosticVisible({ bg = "#0b0f15", fg = "#686f76" }),
    BufferLineInfoDiagnostic({ bg = "#090c11", fg = "#686f76", sp = "#2360b9" }),
    BufferLineInfoSelected({ bg = "#0d1117", fg = "#2f81f7", gui = "bold,italic", sp = "#2f81f7" }),
    BufferLineInfoVisible({ bg = "#0b0f15", fg = "#8b949e" }),
    BufferLineHintDiagnosticSelected({ bg = "#0d1117", fg = "#5d636c", gui = "bold,italic", sp = "#5d636c" }),
    BufferLineHintDiagnosticVisible({ bg = "#0b0f15", fg = "#686f76" }),
    BufferLineHintDiagnostic({ bg = "#090c11", fg = "#686f76", sp = "#5d636c" }),
    BufferLineHintSelected({ bg = "#0d1117", fg = "#7d8590", gui = "bold,italic", sp = "#7d8590" }),
    BufferLineHintVisible({ bg = "#0b0f15", fg = "#8b949e" }),
    BufferLineDiagnosticSelected({ bg = "#0d1117", fg = "#acb1b6", gui = "bold,italic" }),
    BufferLineFill({ bg = "#07090c", fg = "#8b949e" }),
    BufferLineNumbersVisible({ bg = "#0b0f15", fg = "#8b949e" }),
    BufferLineNumbersSelected({ bg = "#0d1117", fg = "#e6edf3", gui = "bold,italic" }),
    BufferLineBufferSelected({ bg = "#0d1117", fg = "#e6edf3", gui = "bold,italic" }),
    ...
    lualine_transitional_lualine_a_normal_to_lualine_b_normal({ bg = "#1c2f45", fg = "#58a6ff", gui = "nocombine" }),
    lualine_transitional_lualine_b_normal_to_lualine_c_normal({ bg = "#0e1219", fg = "#1c2f45", gui = "nocombine" }),
    lualine_transitional_lualine_b_normal_to_lualine_x_11_normal({ bg = "#0e1219", fg = "#1c2f45", gui = "nocombine" }),
    lualine_transitional_lualine_a_insert_to_lualine_b_insert({ bg = "#173322", fg = "#3fb950", gui = "nocombine" }),
    lualine_transitional_lualine_b_insert_to_lualine_c_insert({ bg = "#0e1318", fg = "#173322", gui = "nocombine" }),
    lualine_transitional_lualine_b_insert_to_lualine_x_11_insert({ bg = "#0e1318", fg = "#173322", gui = "nocombine" }),
    ...
    lualine_c_filetype_MiniIconsAzure_replace({ bg = "#0f1218", fg = "#79c0ff", gui = "nocombine" }),
    lualine_c_filetype_MiniIconsAzure_command({ bg = "#0f1319", fg = "#79c0ff", gui = "nocombine" }),
    lualine_c_filetype_MiniIconsAzure_terminal({ bg = "#0f1217", fg = "#79c0ff", gui = "nocombine" }),
    lualine_c_filetype_MiniIconsAzure_inactive({ bg = "#04070d", fg = "#79c0ff", gui = "nocombine" }),
    ...
    lualine_transitional_lualine_b_normal_to_lualine_c_13_normal({ bg = "#0e1219", fg = "#1c2f45", gui = "nocombine" }),
    ...
    lualine_transitional_lualine_a_command_to_lualine_b_command({ bg = "#342f45", fg = "#d2a8ff", gui = "nocombine" }),
