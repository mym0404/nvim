...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    BufferLineBuffer({ bg = "red", fg = "#8b949e" }),
    ...
    BufferLineDuplicateVisible({ fg = "#848c96", gui = "italic" }),
    StatusLineNC({ bg = "#0d1117", fg = "#0d1117", gui = "underline", sp = "#04070d" }),
    BufferLinePickVisible({ fg = "#f85149", gui = "bold,italic" }),
    BufferLinePickSelected({ fg = "#f85149", gui = "bold,italic" }),
    BufferLineDuplicateSelected({ fg = "#848c96", gui = "italic" }),
    BufferLineErrorDiagnosticSelected({ fg = "#ba3c36", gui = "bold,italic", sp = "#ba3c36" }),
    BufferLineErrorDiagnostic({ fg = "#686f76", sp = "#ba3c36" }),
    BufferLineErrorSelected({ fg = "#f85149", gui = "bold,italic", sp = "#f85149" }),
    BufferLineWarningDiagnosticSelected({ fg = "#9d7219", gui = "bold,italic", sp = "#9d7219" }),
    BufferLineWarningDiagnostic({ fg = "#686f76", sp = "#9d7219" }),
    BufferLineWarningSelected({ fg = "#d29922", gui = "bold,italic", sp = "#d29922" }),
    ...
    BufferLineBufferSelected({ fg = "#e6edf3", gui = "bold,italic" }),
