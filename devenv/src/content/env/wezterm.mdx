...
local function setup_core()
	...
	local transparency_mode = true
	local blur_mode = false
	local little_blur = true
	c.window_background_opacity = transparency_mode and 0.45 or blur_mode and is_macos and 0.2 or 0.9
	c.macos_window_background_blur = transparency_mode and 0 or blur_mode and (little_blur and 20 or 40) or 0
