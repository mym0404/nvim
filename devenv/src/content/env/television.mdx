...
```toml filename="~/.config/television/config.toml"
...
# History navigation
# -----------------
up = "select_prev_history"
down = "select_next_history"
...
# --------------------
ctrl-f = "scroll_preview_half_page_down"
ctrl-b = "scroll_preview_half_page_up"
