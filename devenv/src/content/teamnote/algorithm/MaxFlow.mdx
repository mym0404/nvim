...
Algorithm to find the maximum flow in a flow network using Ford-Fulkerson method with BFS.

## Features
- Finds maximum flow from source to sink
- Uses Edmonds-Karp algorithm (BFS-based Ford-Fulkerson)
- Time complexity: O(VE²) where V is vertices, E is edges
- Supports residual graph construction
