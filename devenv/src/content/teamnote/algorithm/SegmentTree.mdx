...
Tree data structure that allows range queries and updates in logarithmic time.

## Features
- Range query (sum, min, max) in O(log n)
- Point update in O(log n)
- Supports various operations like sum, min, max queries
