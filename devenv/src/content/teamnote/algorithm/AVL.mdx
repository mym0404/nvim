...
Self-balancing binary search tree where heights of two child subtrees differ by at most one.

## Features
- Insert, delete, search operations in O(log n)
- Automatic rebalancing through rotations
- Height-balanced structure ensures optimal performance
