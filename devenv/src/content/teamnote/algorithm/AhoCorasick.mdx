...
Multi-pattern string matching algorithm that efficiently finds all occurrences of multiple patterns in a text.

## Features
- Multiple pattern matching in O(n + m + z) time
- Uses trie structure with failure links
- Optimal for finding many patterns simultaneously
- Preprocessing patterns to build automaton
