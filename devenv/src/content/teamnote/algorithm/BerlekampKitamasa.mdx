...
Algorithm for computing the nth term of a linear recurrence relation efficiently.

## Features
- Calculate nth term of linear recurrence in O(k² log n)
- Works with any linear recurrence relation
- Memory efficient matrix exponentiation approach
- Useful for solving recurrence problems
