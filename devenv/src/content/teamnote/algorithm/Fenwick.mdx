...
Data structure for efficient prefix sum queries and point updates.

## Features
- Point update and prefix sum query in O(log n)
- Range update and point query variant
- Range update and range query variant
- Space efficient with O(n) memory
