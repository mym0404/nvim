...
Algorithm to find the lowest common ancestor of two nodes in a tree using binary lifting.

## Features
- Preprocessing in O(n log n) time
- LCA query in O(log n) time
- Distance between two nodes calculation
- Works on any rooted tree structure
