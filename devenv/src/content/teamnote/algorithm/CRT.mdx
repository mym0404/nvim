...
Chinese Remainder Theorem for solving systems of linear congruences.

## Features
- Solve system of congruences efficiently
- Works with pairwise coprime moduli
- Extended Euclidean algorithm integration
