...
Tree decomposition technique that creates a hierarchy of centroids for efficient tree queries.

## Features
- Decomposes tree into O(log n) levels
- Each node appears in O(log n) paths
- Efficient for distance queries and path problems
- Builds auxiliary tree structure
