...
Linear time sieve algorithm for comprehensive number theory computations.

## Features
- Generate all primes up to n in O(n)
- Compute multiplicative functions efficiently
