...
Algorithm to find strongly connected components in a directed graph using Tarjan's algorithm.

## Features
- Finds all SCCs in O(V + E) time
- Uses DFS and stack for cycle detection
- Supports 2-SAT problem solving
- Can construct condensation graph
