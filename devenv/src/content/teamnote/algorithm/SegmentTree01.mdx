...
Specialized segment tree for binary operations and 0-1 problems.

## Features
- Efficient binary range operations
- Count 0s and 1s in range
- Range flip operations
- Binary string manipulations
