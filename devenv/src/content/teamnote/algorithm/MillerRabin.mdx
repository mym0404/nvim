...
Probabilistic algorithm for testing whether a number is prime with high accuracy.

## Features
- Fast primality testing for large numbers
- Deterministic for numbers up to certain bounds with specific witnesses
- Time complexity: O(k log³ n) where k is number of rounds
- Highly accurate with proper witness selection
